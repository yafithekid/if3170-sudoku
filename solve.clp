...
(defrule naked-single-diagonal-kanan
   ...
   (not (possible (value ~?v) (row ?r) (column ?c) (id ?id)))
   
   (possible (value ?v) (row ?r1) (column ?c1) (id ?id2&~?id))
...
(defrule naked-single-diagonal-kiri
...
(defrule locked-candidate-single-line-diagonal
   ...
   (possible (value ?v) (row ?r) (column ?c&:(is-diagonal ?c ?r)) (group ?g))
   
   (not (possible 
				(value ?v) 
				(row ?r1) 
				(column ?c1&:(not(is-same-diagonal ?r ?c ?c1 ?r1)))
				(group ?g)))
   
   (possible (value ?v) (row ?r2) (column ?c2&:(is-same-diagonal ?c ?r ?c2 ?r2)) 
			(group ~?g) (id ?id))
